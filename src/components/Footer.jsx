...
const Footer = () => {
  return (
    ...
    >
      <div className="container mx-auto  flex flex-col md:flex-row  justify-between items-start">
        <div className="w-full md:w-1/3  mb-8 md:mb-0">
          ...
          <p className="text-gray-400">
            ...
            tempora, suscipit, nemo ratione eius quis deleniti accusantium sit
            quos, veniam voluptates harum culpa amet eos fuga ipsam eum cum
            animi.
          </p>
        </div>
        <div>
      ...
      <div className="text-gray-400 border-t border-gray-700 py-4 mt-10  text-center ">

        Copyright 2024 @ khushi Gupta All Right Reserved.
      </div>
    </div>
  );
};
